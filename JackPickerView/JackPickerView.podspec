#
#  Be sure to run `pod spec lint JackPickerView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Jack" => "15122328114@139.com" }
  ...
  s.source_files  = "JackPickerView", "JackPickerView/JackPickerView/JackPickerView.{h,m}”
